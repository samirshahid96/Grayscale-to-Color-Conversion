...
def main():
    ...
    output_image_name = output_dir+image_name+"_"+str(n_slices)+"_sliced_image_"+datetime.now().strftime("%m%d-%H%M%S")+".jpg"
    cv2.imwrite(output_image_name, color_slicing_output)
    output_image_name_t = output_dir + image_name + "_" +"_color_transformed_image_" + datetime.now().strftime("%m%d-%H%M%S") + ".jpg"
